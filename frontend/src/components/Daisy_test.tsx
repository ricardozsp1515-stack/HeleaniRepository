export default function Daisy_test() {
    ...
    <div data-theme="light" className="min-h-screen bg-base-100 flex items-center justify-center">
        <div className="p-6 flex flex-col gap-10">
            ...
            <div className="drawer">
                ...
                <div className="drawer-content">
                    <label htmlFor="my-drawer" className="btn btn-primary">Abrir Drawer</label>
                </div>
            ...
            <div className="toast toast-top toast-end">
                <div className="alert alert-info"><span>Toast info</span></div>
            </div>

            {/* Hero */}
            <div className="hero min-h-[200px] bg-base-200">
